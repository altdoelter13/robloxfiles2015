...
local success, err = pcall(function()	
	...
	playerConnectSucces, player = pcall(function() return client:PlayerConnect(0, "127.0.0.1", 53640, 0, threadSleepTime) end)
	...
	if true then
		pcall(function() game:HttpPost("https://api.roblox.com/auth/negotiate?ticket=" .. rbxApiTicket, "negotiate") end)
		delay(300, function()
			while true do
